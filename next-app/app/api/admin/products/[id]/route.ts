...
const patchSchema = z.discriminatedUnion("action", [
  ...
  z.object({ action: z.literal("pricing"), mrpPaise: z.number().int().nonnegative().optional(), sellingPaise: z.number().int().nonnegative().optional(), costPaise: z.number().int().nonnegative().optional(), offerPaise: z.number().int().nonnegative().optional(), discountBps: z.number().int().min(0).max(10000).optional(), taxBps: z.number().int().min(0).max(10000).optional(), depositPaise: z.number().int().nonnegative().optional(), deliveryPaise: z.number().int().nonnegative().optional(), freeDeliveryOverPaise: z.number().int().nonnegative().optional() }),
