...
window.DOODLY_MANIFEST = (function () {
  ...
  const routes = {
    ...
    "admin/packing": { surface:"admin", title:"Packing", blocks:[ head("Packing Workflow","Pack today's deliveries — advance each stop Pending → Packing → Packed → Ready for Dispatch, or mark a batch at once."), { type:"packingBoard" } ]},
