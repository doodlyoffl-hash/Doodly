...
window.DOODLY_MANIFEST = (function () {
  ...
  const nav = {
    ...
    admin: [
      ...
      { h:"Operations", items:[["Delivery Mgmt","/admin/deliveries.html","truck"],["Auto Assignment","/admin/assignment.html","route"],["Late Deliveries","/admin/late-deliveries.html","clock"],["Address Changes","/admin/scheduled-address-changes.html","pin"],["Serviceable Areas","/admin/serviceable-areas.html","pin"],["Drivers","/admin/drivers.html","user"],["Routes","/admin/routes.html","route"]] },
  ...
  const routes = {
    ...
    "admin/routes": { surface:"admin", title:"Routes", blocks:[ head("Routes","Delivery routes by zone.",[{label:"Plan route",kind:"btn-primary",icon:"route"}]), tbl("routes",{toolbar:false,pager:false}), { type:"html", html:`<div class="mt-3" style="position:relative"><div id="rtOverviewMap" style="min-height:240px;border-radius:16px;overflow:hidden;display:none"></div><div class="media-card" id="rtOverviewPh" style="min-height:240px"><div><div class="big">🗺️</div><div class="muted-sm" id="rtOverviewCap" style="color:rgba(255,255,255,.8);margin-top:6px">Open a route below to see its delivery map — stops appear once their addresses are geocoded.</div></div></div></div>` } ]},
