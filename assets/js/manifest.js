...
window.DOODLY_MANIFEST = (function () {
  ...
  const routes = {
    ...
    "admin/assignment": { surface:"admin", title:"Auto Assignment", blocks:[ head("Auto Delivery Assignment","Pick a date to view that day's live assignment state and run auto-assignment for it — capacity-based (45 bottles/executive), pending queue, return-trip re-assignment and drag-and-drop manual override."), { type:"asgnDateBar" }, { type:"assignment" } ]},
