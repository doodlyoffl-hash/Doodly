...
window.DOODLY_MANIFEST = (function () {
  ...
  const nav = {
    ...
    admin: [
      ...
      { h:"Growth", items:[["Reports","/admin/reports.html","file"],["Revenue","/admin/revenue.html","coins"],["Search Insights","/admin/search-insights.html","search"],["Referrals","/admin/referrals.html","gift"],["Pure Rewards","/admin/loyalty.html","award"],["Coupons","/admin/coupons.html","percent"],["Offers","/admin/offers.html","gift"],["Puzzle Challenge","/admin/puzzles.html","award"],["Reward Management","/admin/rewards.html","gift"]] },
  ...
  const routes = {
    ...
    "check-delivery": { surface:"public", title:"Check Delivery Availability", full:true,
    ...
    "admin/assisted-orders": { surface:"admin", title:"Assisted Order", blocks:[ head("Assisted Order","Place a real order for a customer who called in — same pricing, deposit, wallet, coupon, subscription, payment and delivery as the website. The customer pays by wallet or a Razorpay payment link."), { type:"assistedOrder" }, { type:"assistedReport" } ]},
    ...
    "admin/rewards": { surface:"admin", title:"Reward Management", blocks:[ head("Reward Management","Issue and track claimable rewards — puzzle-winner prizes and manual giveaways. Each is a single-use code + link; claiming it creates a free ₹0 subscription with real deliveries. Every action is audited."), { type:"rewardsAdmin" } ]},
