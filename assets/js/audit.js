...
window.DOODLY_AUDIT = (function () {
  ...
  function seedIfEmpty() {
    ...
    // Production: never fabricate an audit trail — the log starts empty and grows
    // only from real, recorded actions (professional empty state + compliance integrity).
    if (!(window.DOODLY_DEMO_ALLOWED && window.DOODLY_DEMO_ALLOWED())) { saveLog([]); return; }
