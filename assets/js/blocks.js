...
window.DOODLY_BLOCKS = (function () {
  ...
  R.deliveryAnalytics = () => {
    ...
    return `<div class="reveal" id="delAnalytics">
      ...
      <div class="panel mt-3"><div class="panel-head" style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap"><h3>Deliveries per executive</h3><span style="display:flex;gap:8px;flex-wrap:wrap"><button type="button" class="btn btn-ghost sm" id="del-rte-pdf" title="Route report for this day (PDF)">⬇ Route report</button><button type="button" class="btn btn-ghost sm" id="del-rte-xls" title="Route report (Excel)">Excel</button><button type="button" class="btn btn-ghost sm" id="del-rte-csv" title="Route report (CSV)">CSV</button></span></div>
